...
json.error_words v1_learned_book.error_words do |eb|
  json.(eb, :id, :unit_id, :dictionary_id, :repeats, :learns, :reviews)
  json.dictionary @dictionaries[eb.dictionary_id], :id, :book_category, :word, :phonetic_symbol, :acceptation, :example, :picture, :parse, :pronunciation, :usage if @dictionaries
end
