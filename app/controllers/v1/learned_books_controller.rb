class V1::LearnedBooksController < ApplicationController
  ...
  def v1_learned_book_params
    params.fetch(:learned_book, {}).permit(:student_id, :book_id, :learn_type, error_words: [:unit_id, :word_id, :repeats, :learns, :reviews], learned_units: [:id, :completions, :rights, :wrongs, :last_word_index])
  end
end
